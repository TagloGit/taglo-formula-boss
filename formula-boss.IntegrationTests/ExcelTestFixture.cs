...
public sealed class ExcelTestFixture : IDisposable
{
    ...
    public void SetCellColor(dynamic range, int colorIndex)
    {
    ...
    /// </summary>
    public void SetCellBold(dynamic range, int row, int col, bool bold)
    {
        range.Cells[row, col].Font.Bold = bold;
    }
